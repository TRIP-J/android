...
class CommunityHomeFragment :
    ...
    private fun initFAButton() {
        binding.writePostFloatingActionButton.setOnAvoidDuplicateClick {
            findNavController().navigate(CommunityHomeFragmentDirections.actionCommunityHomeFragmentToPostEditFragment())
        }
    }
}